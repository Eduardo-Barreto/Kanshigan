...
`imgsz=640`, aumento padrão do Ultralytics, semente fixa em 42 e parada antecipada no
platô da validação, para que a comparação entre arquiteturas isole o efeito do modelo.
Os hiperparâmetros são versionados no repositório, não escondidos em comentários, para
reprodutibilidade.
