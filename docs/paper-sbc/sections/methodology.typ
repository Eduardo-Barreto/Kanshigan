...
entre quadros usando apenas movimento, sem características de aparência. A
restrição C2 torna a aparência inútil aqui: dois robôs visualmente quase
idênticos não se distinguem por embedding visual, então a associação precisa vir
da coerência do movimento. Comparamos OC-SORT @cao2023ocsort e ByteTrack
@zhang2022bytetrack sobre as mesmas detecções, porque os dois representam
estratégias distintas diante do movimento não linear de colisões e giros (C1): o
OC-SORT corrige o filtro de Kalman com as observações recentes, e o ByteTrack
recupera detecções de baixa confiança, frequentes durante o borrão de movimento.
