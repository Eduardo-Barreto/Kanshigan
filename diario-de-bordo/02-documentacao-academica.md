...
- YOLOv8/v11 (detecção), RT-DETR (transformer-based)
- ByteTrack, BoT-SORT (tracking)
- SAM, SAM 2, SAM 3 (foundation models pra anotação)
- RoboCup SSL/VSSS (trabalhos relacionados com câmera aérea)

**Decisão importante:** SAM é tratado como candidato pra anotação semi-automática, não como escolha definitiva. Resultados preliminares indicam viabilidade.
